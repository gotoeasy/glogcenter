...
func UpdateConfigByEnv() {
	...
	storeRoot = cmn.GetEnvStr("GLC_STORE_ROOT", "/glogcenter")                         // 存储根目录，默认"/glogcenter"
	...
	enableBlackWhiteList = cmn.GetEnvBool("GLC_ENABLE_BLACK_WHITE_LIST", false)        // 是否开启黑白名单
...
// 取配置： 是否开启黑白名单
func IsEnableBlackWhiteList() bool {
